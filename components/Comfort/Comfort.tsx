    ...
    <section className={s.comfort}>
      <div className="container">
        <div className="flex justify-between items-center">
          <div className="w-1/3">
            <h2 className="text-gray-900 text-6xl font-bold leading-10 mb-11">
              <span className="text-blue-400">Со</span> смартфона удобнее
            </h2>

            <p className="text-gray-900 text-xl font-normal leading-8 mb-7">
