...
import СreateWidthGoogle from "@/components/СreateWidthGoogle/СreateWidthGoogle";
...
const CreateAnAccount: FC<IMyModalVideoProps> = ({
  ...
  const [isСreateWidthGoogleModalOpen, setIsСreateWidthGoogleModalOpen] =
    useState(false);
    ...
    <>
      ...
      >
        <Button
          ...
          onClick={() => {
            setIsCreateAnAccountModalOpen(false),
              setIsСreateWidthGoogleModalOpen(true);
          }}
        >
          Продолжить с Google
        </Button>
      ...
      <СreateWidthGoogle
        ...
        setIsСreateWidthGoogleModalOpen={setIsСreateWidthGoogleModalOpen}
      />
    </>
  );
};
