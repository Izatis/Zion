    ...
    <nav className="flex justify-between my-14 items-center">
      <div className="flex flex-col gap-8 w-2/3">
        ...
        <p className="text-white font-sans font-normal font-400 text-lg leading-7">
          Zion Assist организации, в особенности же <br />
          постоянный количественный рост и сфера нашей <br />
          активности требуют определения.
        </p>
      ...
      <div className="w-1/3 flex justify-between">
        <div>
          <h2 className="text-white text-2xl font-normal font-semibold leading-8 mb-6">
            Компания
          </h2>

          <ul className="flex flex-col">
            <li className="text-white text-base font-normal leading-8">
              О компании
            </li>
            <li className="text-white text-base font-normal leading-8">
              Контакты
