...
import { DatePicker, Input, Menu, MenuProps } from "antd";
            ...
            {current === "1" ? (
              <ul className="flex justify-between gap-4 py-8">
                <li className="relative">
                  <Input className="hero__input" placeholder="Откуда" />
                  <Image
                ...
                <li>
                  <Input className="hero__input" placeholder="Куда" />
                </li>
                <li>
              ...
              <ul className="flex justify-between gap-4 py-8"></ul>
            )}
          </div>
        </div>
      </section>
