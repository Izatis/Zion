...
const Hero = () => {
  // const [isPasswordRecoveryModalOpen, setPasswordRecoveryIsModalOpen] =
  //   useState(true);
  return (
    <>
      ...
      {/* <PasswordRecovery
        isPasswordRecoveryModalOpen={isPasswordRecoveryModalOpen}
        setPasswordRecoveryIsModalOpen={setPasswordRecoveryIsModalOpen}
      /> */}
    </>
  );
};
